...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/yannti/thema/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : firdistore   ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : HOKAOFFC     ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by HOKAGEOFFC   ${NC}"
